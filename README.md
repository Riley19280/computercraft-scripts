...
This appears to only work on windows, as symbolic links on linux do not appear to be read correctly.

To avoid that, `hardlinker.sh` will link all the files in the directory