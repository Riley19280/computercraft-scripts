...
function plane.vertical(length, height)
...
function plane.horizontal(width, length, direction)
...
function cli_input()
    if arg1 == 'wall' or arg1 == 'vertical' then
        return plane.vertical(tonumber(args[2]), tonumber(args[3]))
    end
    
    
    if arg1 == 'ceiling' then
        return plane.horizontal(tonumber(args[2]), tonumber(args[3]), 'up')
    end
    
    if arg1 == 'floor' then
        return plane.horizontal(tonumber(args[2]), tonumber(args[3]), 'down')
    end
    
    if arg1 == 'horizontal' then
        if args[2] == 'up' then
            return plane.horizontal(tonumber(args[3]), tonumber(args[4]), 'up')
        elseif args[2] == 'down' then
            return plane.horizontal(tonumber(args[3]), tonumber(args[4]), 'down')
        else
...
if shell.getRunningProgram() == 'plane.lua' then
    cli_input()
end
